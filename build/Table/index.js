...
function Table(props) {
    ...
    return (React.createElement(ATable, Object.assign({ style: { width: `${tableWidth}px` }, components: components, columns: columns, pagination: pagination, className: 'table ' + className, rowKey: (record, index) => index, dataSource: data, scroll: scroll }, otherConfig)));
}
